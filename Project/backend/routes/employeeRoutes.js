...
const { validateEmployee, updateEmployee, validateQueryEmployee } = require('../validations/employeeValidation');
...
router.put('/:id', authorizeRole([1, 2]), updateEmployee, employeeController.updateEmployee);
