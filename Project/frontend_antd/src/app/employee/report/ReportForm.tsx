...
const App: React.FC = () => {
    ...
    const handleCancel = () => {
        form.resetFields(['Name', 'Department', 'Type', 'Note']); // Reset các trường trừ Date Created
    };
            ...
            >
                ...
                >
                    <Select>
                        ...
                        <Select.Option value="denunciation">Denunciation</Select.Option>
                        <Select.Option value="deedback">Feedback</Select.Option>
                    </Select>
                </Form.Item>
